...
RUN apk --update add curl drill groff util-linux bash xauth gettext openssl-dev shadow sudo iptables busybox-extras vim net-tools ca-certificates libqrencode && \
